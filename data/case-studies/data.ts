...
export const dataCaseStudies: CaseStudy[] = [
  {
    ...
    overview:
      "Designed and built a comprehensive real-time analytics platform that unified data from 15+ disparate systems into a single source of truth for executive decision-making.",
    challenge:
      "Leadership was making critical decisions based on week-old data from fragmented Excel reports. They needed real-time visibility into operations, costs, and performance metrics across 200+ distribution centers.",
    solution:
      "We architected a modern data stack using Snowflake, dbt, and custom React dashboards. Built ETL pipelines processing 2TB daily, with sub-second query performance. Implemented role-based views for different stakeholder groups.",
    results: [
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1604999565976-8913ad2ddb7c?q=80&w=800&h=600&fit=crop",
    summary:
    ...
    overview:
      "Developed an advanced customer segmentation system using behavioral analytics and machine learning to enable hyper-targeted marketing campaigns.",
    challenge:
      "The client was running generic campaigns with low conversion rates. They had rich customer data but no systematic way to identify high-value segments or personalize messaging.",
    solution:
      "We implemented RFM analysis combined with K-means clustering and propensity modeling. Built automated segment refresh pipelines and integrated with their marketing automation platform for real-time personalization.",
    results: [
  ...
  },
  {
    ...
    overview:
      "Built a predictive churn model that identifies at-risk customers 60 days before cancellation, enabling proactive retention efforts.",
    challenge:
      "The company was losing 8% of customers monthly with no early warning system. By the time customers contacted support about canceling, it was too late to intervene effectively.",
    solution:
      "We developed a gradient boosting model analyzing 200+ behavioral signals including usage patterns, support tickets, and engagement metrics. Integrated predictions into their CRM with automated playbooks for customer success teams.",
    results: [
